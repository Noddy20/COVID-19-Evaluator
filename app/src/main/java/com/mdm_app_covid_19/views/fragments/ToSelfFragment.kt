...
class ToSelfFragment : Fragment(){

    companion object {
        private const val TAG = "ToSelfFragment"

        fun newInstance(): ToSelfFragment {
            return ToSelfFragment().also { it.arguments = bundleOf() }
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_to_self, container, false)
    }
